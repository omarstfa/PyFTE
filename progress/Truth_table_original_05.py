...
and1 = Gate('AND', parent=intermediateEvent3)
basicEvent3 = Event('Basic Event 3', parent=and1)
intermediateEvent4 = Event('Intermediate Event 4', parent=and1)
...
basicEvent16 = Event('Basic Event 16', parent=or4)
basicEvent17 = Event('Basic Event 17', parent=or4)
